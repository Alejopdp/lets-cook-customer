...
const TaggedBlogPage = (props) => {
    ...
    return (
        <Layout seoTitle={props.seoTitle} canonicalUrl={`${process.env.NEXT_PUBLIC_DOMAIN}/blogs/cocina/tagged/${router.query.tag}`}>
...
export async function getServerSideProps(context) {
    const categoriesRes = await getCategories(context.locale, { Type: BlogType.Cocina });
