...
const BlogPostPage = ({ post, error }) => {
    ...
    return (
        <Layout
            ...
            canonicalUrl={`${process.env.NEXT_PUBLIC_DOMAIN}/blogs/cocina/${post.slug}`}
        >
            <InnerSectionLayout containerMaxWidth="md">
                <BackButtonTitle url={`${localeRoutes[router.locale][Routes.blogs]}/cocina`} title="Volver al Blog" />
