    ...
    const plans = [
        {
            ...
            icon: "/icons/plan-familiar.svg",
            checkedIcon: "/icons/plan-familiar-color.svg",
        },
        {
            name: "Plan Gourmet",
            description: "Plan Gourmet lorem ipsum dolor sit amet",
            icon: "/icons/plan-gourmet.svg",
            checkedIcon: "/icons/plan-gourmet-color.svg",
        },
        {
            name: "Plan Ahorro",
            description: "Plan Ahorro lorem ipsum dolor sit amet",
            icon: "/icons/plan-ahorro.svg",
            checkedIcon: "/icons/plan-ahorro-color.svg",
        },
        {
            name: "Plan Vegetariano",
            description: "Plan Vegetariano lorem ipsum dolor sit amet",
            icon: "/icons/plan-vegetariano.svg",
            checkedIcon: "/icons/plan-vegetariano-color.svg",
        },
        {
            name: "Plan Vegano",
            description: "Plan Vegano lorem ipsum dolor sit amet",
            icon: "/icons/plan-vegano.svg",
            checkedIcon: "/icons/plan-vegano-color.svg",
        },
        {
            name: "Plan X",
