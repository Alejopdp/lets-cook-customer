...
// External components
import { AddCircleOutline as AddCircleOutlineIcon, Settings as SettingsIcon, Restore as RestoreIcon, Star as StarIcon, Wallet as WalletIcon } from "@material-ui/icons";
...
const TextButton = (props) => {
    ...
    return isSmDown && props.icon ? (
        <IconButton size="small" style={props.style} onClick={props.handleClick}>
            ...
            ) : props.icon === "star" ? (<StarIcon style={!isSmDown ? { marginRight: "6px" } : null} />) : props.icon === "wallet" ? (<WalletIcon style={!isSmDown ? { marginRight: "6px" } : null} />) : null}
        </IconButton>
    ) : (
        <Button
            size="small"
