...
const CancelPlanModal = (props) => {
    ...
    const handleClickCancel = () => {
        alert(`Cancel plan + ${cancellationComments}`)
        props.handleClose()
    }
    ...
    if (reasonSelected) {
        switch (reasonSelected.value) {
            case 'created_by_error':
                cancellationReasonComponent = <CreatedByError handleChange={handleChangeCancellationComments} value={cancellationComments} />
            ...
            case 'cant_get_kits_next_week':
                cancellationReasonComponent = <CantGetKitsNextWeek handleChange={handleChangeSkipWeeks} weeks={skipWeekData.weeks} value={weeksToSkip} />
                ...
                break;
            case 'special_diet':
                cancellationReasonComponent = <SpecialDiet handleChangeSelect={handleChangeSelectSpecialDiet} valueSelect={specialDiet.value} handleChangeComments={handleChangeCommentsSpecialDiet} valueComments={specialDiet.comments} />
                handleSecondaryBtnClick = handleClickCancel
                secondaryBtnColor = '#FC1919'
                secondaryBtnText = 'no gracias, deseo cancelar'
            ...
            case 'dont_like_meal_kits':
                cancellationReasonComponent = <DontLikeMealKits handleChange={handleChangeCancellationComments} value={cancellationComments} />
                handleSecondaryBtnClick = props.handleClose
                secondaryBtnColor = theme.palette.text.secondary
                secondaryBtnText = 'cerrar'
                handlePrimaryBtnClick = handleClickCancel
            ...
            case 'had_problems_with_letscook':
                cancellationReasonComponent = <HadProblemsWithLetsCook handleChange={handleChangeCancellationComments} value={cancellationComments} />
                handleSecondaryBtnClick = props.handleClose
                secondaryBtnColor = theme.palette.text.secondary
                secondaryBtnText = 'cerrar'
                handlePrimaryBtnClick = handleClickCancel
                ...
                break;
            case 'price_too_high':
                cancellationReasonComponent = <PriceTooHigh plan={plan} variants={variants} planVariantIdSelected={planVariantIdSelected} setPlanVariantIdSelected={setPlanVariantIdSelected} />
                handleSecondaryBtnClick = handleClickCancel
                secondaryBtnColor = '#FC1919'
                secondaryBtnText = 'no gracias, deseo cancelar'
