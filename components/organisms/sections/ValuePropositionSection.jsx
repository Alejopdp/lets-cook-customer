                ...
                <div className={classes.overlay}>
                    <div className={classes.textContent}>
                        ...
                        <Typography variant="body1" style={{ marginBottom: theme.spacing(3) }}>
                            Pensamos por ti <b>recetas sanas y equilibradas</b> con la mejor selección de{" "}
                            <b>ingredientes frescos y naturales</b> y te las enviamos <b>semanalmente</b> a la puerta de tu casa
                        </Typography>
                        <RoundedButton label="Ver planes" />
                        <Typography style={{ marginTop: theme.spacing(0.5) }} variant="caption">
