export const home = {
    es: {
        valuePropositionSection: {
            title: "Cocina bueno y rico cada semana",
            subtitle: "¿Qué hay para cenar? Te enviamos ingredientes frescos en cantidades exactas con la receta para cocinar en tu casa.",
            btnText: "Ver planes",
            btnCaption: "Podrás pausar, cambiar o cancelar el plan cuando quieras",
        },
        howItWorksSection: {
            title: "¿Cómo funciona?",
            cards: [
            ...
            btnCaption: "Nuevas recetas cada semana",
        },
        plansSection: {
    ...
    en: {
        valuePropositionSection: {
            title: "Cook healthy and delicious meals every week",
            subtitle:
                "What’s for dinner? We deliver fresh ingredients in the exact quantities together with recipes for you to prepare delicious home cooked meals.",
            btnText: "View plans",
            btnCaption: "You can pause, change or cancel your plan at any time",
        },
        howItWorksSection: {
            ...
            btnText: "Get cooking",
            btnCaption: "New recipes every week",
        },
        plansSection: {
    ...
    ca: {
        valuePropositionSection: {
            title: "Cuina bo i deliciós cada setmana",
            subtitle: "Què hi ha per sopar? T’enviarem ingredients frescos en quantitats exactes amb la recepta per cuinar a casa teva.",
            btnText: "Veure plans",
            btnCaption: "Podràs pausar, canviar o cancel·lar el pla quand vulguis",
        },
        howItWorksSection: {
            title: "Com funciona?",
            subtitle: "...",
            ...
            btnCaption: "Noves receptes cada setmana",
        },
        plansSection: {
            title: "Troba el pla indicat per a tu",
            subtitle: "...",
            btnText: "Ho vull!",
        },
        benefitsSection: {
